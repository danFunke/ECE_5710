...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot dpram32x16 xil_defaultlib.dpram32x16 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim dpram32x16 -key {Behavioral:sim_1:Functional:dpram32x16} -tclbatch cmd.tcl -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="E:/Xilinx/Vivado/2022.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb dpram32x16.wdb xsim.dir)

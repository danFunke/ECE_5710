...
#
# Generated by export_simulation on Sun Nov 13 17:41:22 -0500 2022
#
################################################################################
...
'-reset_run' switch to the './dpram32x16.sh' script.

./dpram32x16.sh -reset_run
...
./dpram32x16.sh -noclean_files

For more information on the script, please type './dpram32x16.sh -help'.
